...
**Load Leads:** The flow starts by loading lead data from a CSV file named leads.csv.

**Score Leads:** The LeadScoreCrew is kicked off to score the loaded leads based on predefined criteria.
